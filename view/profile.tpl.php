        ...
        <div id="page-wrapper" data-ng-controller="ProfileController">
   			<div class="row">
   				<div class="col-md-12">
   					...
   					<form class="form-horizontal" data-ng-submit="saveProfileData()">
   						<fieldset>
   							<div class="form-group">
                               <input class="form-control input-md" required="true" type="hidden" name="userId" id="userId" value="<?php echo $pageData['userInfo']['id_user']; ?>">
   			...
   			<div class="row">
   				<div class="col-md-12">
   					...
   					<form class="form-horizontal"  data-ng-submit="updatePassword()">
   						<input type="hidden" name="userId" id="userId" value="<?php echo $pageData['userInfo']['id_user']; ?>">
   						<fieldset>
   							<div class="form-group">
